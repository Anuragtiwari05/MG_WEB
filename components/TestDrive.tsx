...
export default function TestDrive() {
  ...
  // Disallow today/past dates — a same-day walk-in isn't guaranteed a slot,
  // so the calendar's earliest selectable day is tomorrow. The field itself
  // stays blank until the user actually picks a date.
  useEffect(() => {
        ...
        <div className="overflow-hidden rounded-lg border border-border shadow-[0_4px_32px_0_rgba(0,44,95,0.08)] lg:grid lg:grid-cols-[0.9fr_1.1fr]">
          ...
          <Reveal variant="slide-right" className="relative min-h-[280px] overflow-hidden lg:min-h-full">
            <Image
              ...
              title="MG interior and dashboard"
              fill
          ...
          <div className="relative w-full max-w-md rounded-2xl bg-white p-6 sm:p-8 text-center shadow-2xl border border-slate-100 animate-in zoom-in-95 duration-200">
            ...
            <p className="mt-4 text-sm sm:text-base leading-relaxed text-slate-600 font-normal">
              ...
              <strong className="font-semibold text-slate-900">
                {carModel ? (carModel.toUpperCase().startsWith("MG") ? carModel : `MG ${carModel}`) : "MG Vehicle"}
              </strong>.
            </p>
