          ...
          <Reveal className="lg:col-span-1">
            <div>
              ...
              <p className="mt-5 text-sm sm:text-base text-black/60 leading-relaxed max-w-sm">
                Still unsure about something? Talk to our team and we&apos;ll clear it up faster than any FAQ.
              </p>
              ...
              {data.map((faq, i) => {
                ...
                return (
                  <div key={i} className="py-4 sm:py-5">
                    ...
                    >
                      <span className={`text-base sm:text-lg font-semibold tracking-tight transition-colors duration-300 ${
