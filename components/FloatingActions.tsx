...
const actions = [
  ...
  { label: "WhatsApp", href: `https://wa.me/918655918814?text=${encodeURIComponent("Hi, I wanted to book a test drive")}`, Icon: WhatsApp },
...
export default function FloatingActions() {
  ...
  return (
    <div
      ...
      className="fixed right-0 top-1/2 z-40 hidden -translate-y-1/2 items-center md:flex"
      style={{
        transform: isOpen
    ...
    >
      ...
      <button
        ...
        className="absolute right-full top-1/2 flex h-12 w-5 -translate-y-1/2 items-center justify-center rounded-l-md border border-r-0 border-white/20 bg-brand text-white transition-colors hover:bg-brand-light"
