      ...
      <div className="container-px mx-auto max-w-[1400px]">
        ...
        <Reveal className="mb-12 max-w-xl">
          ...
          <h2 className="mt-2 font-display text-3xl font-black tracking-wide text-text sm:text-4xl">
            Buying a MG in four simple steps
          </h2>
          <p className="mt-4 text-sm text-muted">
            From shortlisting to delivery and aftercare, we make buying and owning a MG straightforward, transparent, and completely hassle-free.
          </p>
        </Reveal>
