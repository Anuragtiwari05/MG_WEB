...
export const company = {
  ...
  phone: "72290 51111",
  phoneE164: "+917229051111",
  phoneSelect: "82388 04111",
  phoneSelectE164: "+918238804111",
  email: "mumbaiwest.marketingmanager@mgdealer.co.in",
  emailSelect: "cem.krishiv.mum@mgselectdealer.co.in",
  primaryAddress: {
    street: "Shakti Premises, New Link Rd, near Inorbit Mall, opposite Cloud Nine Hospital, Malad West",
    locality: "Mumbai",
    region: "Maharashtra",
    postalCode: "400064",
    country: "IN",
  },
  hours: "Mon to Sun, 9:30 AM to 6:30 PM",
  hoursSelect: "Mon to Sun, 9:30 AM to 8:00 PM",
  hoursSpec: { days: "Mo-Su", opens: "09:30", closes: "18:30" },
  areasServed: ["Mumbai", "Malad", "Andheri", "Vasai"],
  stats: {
    legacy: "100+ Years",
  ...
  social: {
    facebook: "https://www.facebook.com/mgmotormumbaiwest/",
    instagram: "https://www.instagram.com/mgmotor_mumbaiwest?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==",
...
export const groupInfo = {
  ...
  headquarters:
    "Shakti Premises, New Link Rd, near Inorbit Mall, opposite Cloud Nine Hospital, Malad West, Mumbai, Maharashtra 400064",
};
...
export const aboutFaqData = [
  ...
  },
  {
    ...
    answer:
      "Beyond new car sales, we offer vehicle finance and exchange, genuine-parts servicing, MG Select premium vehicle sales, and dedicated after-sales support across all our Mumbai locations.",
  },
  {
...
export type Slide = {
  ...
  exploreSlug?: string;
  // Skip this slide in the mobile hero carousel (desktop still shows it) —
  // e.g. banners whose baked-in text collides with the mobile crop.
...
export const heroSlides: Slide[] = [
  ...
  },
  {
    ...
    price: "65.00",
    // This banner (cybie-kmi-desktop.webp) is a plain track photo with no
    // baked-in text — hasImageText:true was wrongly suppressing our own
    // badge/headline overlay on desktop, leaving that slide blank.
  ...
  },
  {
    ...
    // entry below) — surfaced as real text on mobile alongside the transparent
    // car cutout, which carries no baked marketing copy of its own.
  ...
  },
  {
    ...
    price: "45.00",
    // Plain road photo, no baked-in text — same fix as Cyberster above.
  ...
  },
  {
    ...
    features: [],
    // Wide desert/scissor-door shot with baked-in text on the left half — on the
    // mobile crop (narrow, centered, object-bottom) it zooms in on just the door
    // and mirror, which reads as the car "flying". Desktop still shows it full-bleed.
    mobileExclude: true,
  },
];
...
export function getCarBrandedName(car: { name: string; category: CarCategory }): string {
  return car.category === "Select" ? `MG Select ${car.name}` : `MG ${car.name}`;
}

export function getCarTransparentImage(id: string): string {
  switch (id) {
    case "astor": return "/images/models/model-astor-transparent.png";
    case "hector": return "/images/models/model-hector-v3.png";
    case "zs-ev": return "/images/models/model-zs-ev-edited.png";
...
export const cars: Car[] = [
  {
    ...
    brochureUrl: "/brochures/astor.pdf",
    galleryImages: [
  ...
  },
  {
    ...
    brochureUrl: "/brochures/hector.pdf",
    galleryImages: [
  ...
  },
  {
    ...
    cta: "Explore ZS EV",
    image: "/images/models/model-zs-ev-edited.png",
    alt: "MG ZS EV SUV",
    seating: "5 Seater",
    ...
    brochureUrl: "/brochures/zs-ev.pdf",
    galleryImages: [
  ...
  },
  {
    ...
    brochureUrl: "/brochures/windsor-ev.pdf",
    galleryImages: [
  ...
  },
  {
    ...
    brochureUrl: "/brochures/comet-ev.pdf",
    galleryImages: [
  ...
  },
  {
    ...
    image: "/images/models/model-majestor-v3.png",
    alt: "MG Majestor SUV",
    seating: "7 Seater",
    mileage: "12.4 kmpl",
    ...
    brochureUrl: "/brochures/majestor.pdf",
    galleryImages: [
  ...
  },
  {
    ...
    heroImage: "/images/models/model-cyberster-v2.png",
    interiorImage: "/images/models/cyberster/48-dashboard-59.jpg",
    galleryImages: [
      { src: "/images/models/cyberster/cyberster-hero-red.jpg", caption: "MG Cyberster - Commanding front-left road posture" },
    ...
    colors: [
      { name: "Dynamic Red", hex: "#cc0000", cssFilter: "none", image: "/images/models/cyberster/cyberster-hero-red.jpg" },
      ...
      { name: "Andes Grey", hex: "#3b3b3b", cssFilter: "none", image: "/images/models/cyberster/Andes-Grey_3b3b3b.jpg" },
    ],
    details: {
      length: "4535 mm",
      width: "1913 mm",
...
export const trust = [
  ...
  },
  {
    ...
    text: "Strategically located showrooms and state-of-the-art service workshops across Mumbai, Malad, Vasai & Worli.",
  },
  {
    icon: "rupee",
...
export const testimonials: Testimonial[] = [
  {
    name: "Kainaz Patel",
    role: "MG Windsor Owner · Malad",
    rating: 5,
    text: "We just bought an MG Windsor and Mr. Devang (Malad showroom) was a wonderful relationship manager helping us with a smooth process towards buying the new car. Thank you and all the best.",
    avatar: "/images/logo-mg.png",
  },
  {
    name: "Anita Ameta",
    role: "MG Hector Owner · Malad",
    rating: 5,
    text: "Had a wonderful experience with MG Hector at Krishiv MG. The staff was extremely helpful, kind, and welcoming throughout the whole process. They arranged everything so nicely and made the delivery experience really special and memorable.",
    avatar: "/images/logo-mg.png",
  },
  {
    name: "Jayita Ramani",
    role: "Vasai Showroom",
    rating: 5,
    text: "We had a wonderful experience buying our car from MG Motors. A special thanks to Sharmishtha and Sumukh for their excellent support throughout the entire process. They were professional, patient, responsive, and made the whole car-buying journey very smooth and stress-free.",
    avatar: "/images/logo-mg.png",
  },
  {
    name: "Chirag Jain",
    role: "Vasai Showroom",
    rating: 5,
    text: "Had the best experience, loved the way Krunal helped us with all the process and paperwork. He's a highly skilled professional - will highly recommend everyone to visit the showroom and have the best experience ever.",
    avatar: "/images/logo-mg.png",
  },
  {
    name: "Dishant Doshi",
  ...
  },
  {
    ...
    rating: 5,
    text: "Best service. Mujaheed was extra careful with the delivery. We purchased an MG Windsor top-end variant and are very happy with the service - MG cars are very comfortable.",
    avatar: "/images/logo-mg.png",
  },
  {
    name: "Zameer Shaikh",
    role: "Worli Showroom",
    rating: 5,
    text: "A very good showroom - my experience was 10/10. Helpful staff, quick and on-time, hassle-free delivery, and the ambience inside is calming too. Special thanks to Mansi, my RM, for making everything easy and convenient.",
    avatar: "/images/logo-mg.png",
  },
];
...
export const faqData = [
  {
    ...
    answer:
      "You can book a test drive online using the form on our website, or by calling us at 72290 51111. Our team will verify your details and coordinate the test drive at your nearest showroom or at your doorstep.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "MG Select is MG's premium sub-brand for flagship models like the Cyberster and M9, offered through our dedicated MG Select showroom at Worli. It comes with a more personalised buying experience, private viewings, and bespoke test drives alongside the regular MG lineup.",
  },
];
  ...
  astor: [
    {
      ...
      answer:
        "The MG Astor, powered by a 1.5L VTi-TECH petrol engine (110 PS, 144 Nm), returns an ARAI-rated mileage of 14.5 kmpl and is offered with 5-Speed Manual or CVT transmission options.",
    },
    {
      question: "How many people can the MG Astor seat?",
      answer:
        "The MG Astor is a 5-seater mid-size SUV with 488 litres of boot space, making it comfortable for daily city driving as well as longer family trips.",
    },
    {
      question: "What makes the MG Astor's Personal AI Assistant special?",
      answer:
        "The Astor is one of the few SUVs in its segment with a Personal AI Assistant robot mounted on the dashboard - it responds to voice commands, displays human-like emotions, and works alongside the i-SMART suite of 80+ connected features.",
    },
    {
      question: "What safety features does the MG Astor offer?",
      answer:
        "The Astor comes with Level 2 ADAS covering 14 autonomous driving features, 6 airbags, ESP, ABS with EBD, Hill Hold Control, a 360-degree Around View Camera, and heated ORVMs.",
    },
    {
      question: "How do I book a test drive for the MG Astor?",
      answer:
        "You can book a test drive for the MG Astor online using the form on our website, or by calling MG Motor Mumbai directly. Our team will confirm your slot at your nearest showroom or arrange a doorstep test drive.",
    },
  ],
  hector: [
    {
      question: "What engine and mileage options does the MG Hector offer?",
      answer:
        "The Hector is offered with a 1.5L Turbo Petrol or 2.0L Diesel engine (143 PS, 250 Nm) paired with 6-Speed Manual or CVT transmission, delivering an ARAI-rated mileage of 13.7 kmpl.",
    },
    {
      question: "How many people can the MG Hector seat?",
      answer:
        "The MG Hector is available in 5, 6, or 7-seater configurations, with a generous 587 litres of boot space for luggage and everyday essentials.",
    },
    {
      question: "What is special about the MG Hector's infotainment system?",
      answer:
        "The Hector features India's largest 14-inch HD Portrait touchscreen, running the i-SMART connected suite with 80+ features, along with i-SWIPE touch gesture control for a more immersive 'Internet SUV' experience.",
    },
    {
      question: "What safety features does the MG Hector offer?",
      answer:
        "The Hector comes with Level 2 ADAS covering 11 autonomous features, 6 airbags as standard, a 360 HD Camera with a unique Wheel View mode, and ABS, EBD, ESP with Traction Control.",
    },
    {
      question: "How do I book a test drive for the MG Hector?",
      answer:
        "You can book a test drive for the MG Hector online through our website or by calling MG Motor Mumbai. We'll confirm your appointment at your nearest showroom or arrange a doorstep test drive.",
    },
  ],
  "zs-ev": [
    {
      question: "What is the range of the MG ZS EV?",
      answer:
        "The MG ZS EV is equipped with a 50.3 kWh prismatic LFP battery and a 176 PS motor, offering a claimed range of up to 461 km on a full charge, with 0-100 km/h acceleration in 8.5 seconds.",
    },
    {
      question: "How many people can the MG ZS EV seat?",
      answer:
        "The MG ZS EV is a 5-seater premium electric SUV with 448 litres of boot space, suitable for both daily commutes and longer drives.",
    },
    {
      question: "What safety features does the MG ZS EV offer?",
      answer:
        "The ZS EV comes with 6 airbags, Level 2 ADAS features including Lane Keep Assist and Adaptive Cruise Control, Blind Spot Detection, and Rear Cross Traffic Alert.",
    },
    {
      question: "What tech features come with the MG ZS EV?",
      answer:
        "The ZS EV offers a 10.1-inch HD touchscreen, Digital Bluetooth Key, PM 2.5 air purifier, and a dual-pane panoramic skyroof for a premium, connected driving experience.",
    },
    {
      question: "How do I book a test drive for the MG ZS EV?",
      answer:
        "You can book a test drive for the MG ZS EV online via our website or by calling MG Motor Mumbai. Our team will arrange the test drive at your nearest showroom or at your doorstep.",
    },
  ],
  "windsor-ev": [
    {
      question: "What is the range of the MG Windsor EV?",
      answer:
        "The MG Windsor EV is powered by a 38 kWh battery pack and a 136 PS motor, offering a claimed range of up to 331 km on a full charge.",
    },
    {
      question: "What kind of vehicle is the MG Windsor EV?",
      answer:
        "The Windsor EV is positioned as a Business Class CUV - combining the comfort and luxury of a sedan with the space of an SUV, complete with 135-degree reclining Aero Lounge rear seats.",
    },
    {
      question: "How many people can the MG Windsor EV seat, and how much boot space does it have?",
      answer:
        "The MG Windsor EV seats 5 and offers a spacious 604 litres of boot space, among the largest in its class.",
    },
    {
      question: "What safety features does the MG Windsor EV offer?",
      answer:
        "The Windsor EV comes with 6 airbags, Electronic Stability Program (ESP), a 360-degree Surround View Camera, and Hill Start Assist with Descent Control.",
    },
    {
      question: "How do I book a test drive for the MG Windsor EV?",
      answer:
        "You can book a test drive for the MG Windsor EV online through our website or by calling MG Motor Mumbai, and we'll arrange it at your nearest showroom or at your doorstep.",
    },
  ],
  "comet-ev": [
    {
      question: "What is the range of the MG Comet EV?",
      answer:
        "The MG Comet EV is powered by a 17.3 kWh IP67-certified battery and a 42 PS motor, offering a claimed range of up to 230 km on a full charge.",
    },
    {
      question: "How many people can the MG Comet EV seat?",
      answer:
        "The MG Comet EV is a 4-seater smart city hatchback with 150 litres of boot space, designed for compact, easy city driving and parking.",
    },
    {
      question: "What makes the MG Comet EV good for Mumbai's city traffic?",
      answer:
        "At just 2974 mm long with a tight turning radius, the Comet EV is one of the easiest cars to park and manoeuvre through Mumbai's narrow lanes and dense traffic.",
    },
    {
      question: "What safety features does the MG Comet EV offer?",
      answer:
        "The Comet EV comes with dual front airbags, rear parking sensors and camera, ISOFIX child seat anchors, and ABS with EBD.",
    },
    {
      question: "How do I book a test drive for the MG Comet EV?",
      answer:
        "You can book a test drive for the MG Comet EV online through our website or by calling MG Motor Mumbai, and our team will arrange it at your nearest showroom or at your doorstep.",
    },
  ],
  majestor: [
    {
      question: "What is the mileage of the MG Majestor?",
      answer:
        "The MG Majestor is powered by a 2.0L Twin-Turbo Diesel engine producing 215.5 PS and 480 Nm of torque through an 8-Speed Automatic transmission, with an ARAI-rated mileage of 12.4 kmpl.",
    },
    {
      question: "How many people can the MG Majestor seat?",
      answer:
        "The MG Majestor is a premium 7-seater SUV with 343 litres of boot space, offering business-class second-row captain seats for maximum comfort.",
    },
    {
      question: "What luxury features does the MG Majestor offer?",
      answer:
        "The Majestor comes with a panoramic sunroof, heating/ventilation and massage front seats, 70+ next-gen connected features, three-zone climate control, and a 12-speaker premium sound system.",
    },
    {
      question: "What safety features does the MG Majestor offer?",
      answer:
        "The Majestor is equipped with Level 2 ADAS, 6 airbags with ESP, Adaptive Cruise Control, Forward Collision Warning, Automatic Emergency Braking, and Lane Keep Assist.",
    },
    {
      question: "How do I book a test drive for the MG Majestor?",
      answer:
        "You can book a test drive for the MG Majestor online through our website or by calling MG Motor Mumbai, and our team will arrange it at your nearest showroom or at your doorstep.",
    },
  ],
  m9: [
    {
      question: "What is the range of the MG M9?",
      answer:
        "The MG M9 is powered by a 90 kWh battery pack and a dual-motor setup producing 245 hp (180 kW), offering a claimed range of up to 480 km on a full charge.",
    },
    {
      question: "How many people can the MG M9 seat?",
      answer:
        "The MG M9 is a 7-seater luxury electric MPV with 650 litres of boot space, featuring individual business-class lounge seating in the second row with folding tray tables and armrest controls.",
    },
    {
      question: "What makes the MG M9's doors and cabin special?",
      answer:
        "The M9 features electric sliding side doors, a panoramic glass roof with mood lighting, and 64-color ambient lighting, creating a first-class travel experience for every passenger.",
    },
    {
      question: "What safety features does the MG M9 offer?",
      answer:
        "The M9 comes with 10 airbags, Autonomous Emergency Braking, Lane Change Assist and Lane Keeping Assist, and a 360 High-Definition Monitor Suite.",
    },
    {
      question: "How do I book a test drive for the MG M9?",
      answer:
        "You can book a test drive for the MG M9 online through our website or by calling MG Motor Mumbai. As an MG Select model, it's showcased at our dedicated MG Select showroom in Worli, where our team will arrange a bespoke test drive.",
    },
  ],
  cyberster: [
    {
      question: "What is the range and performance of the MG Cyberster?",
      answer:
        "The MG Cyberster is powered by a 77 kWh battery with a dual-motor AWD setup, offering a claimed range of up to 509 km along with blistering 0-100 km/h acceleration in just 3.2 seconds.",
    },
    {
      question: "Is the MG Cyberster a 2-seater?",
      answer:
        "Yes. The Cyberster is a 2-seater electric roadster with 200 litres of boot space, built on a lightweight, high-rigidity sports monocoque platform for true sports-car dynamics.",
    },
    {
      question: "What makes the MG Cyberster's design stand out?",
      answer:
        "The Cyberster is instantly recognisable for its automatic scissor doors, wrap-around triple-screen cockpit display, and an electric soft convertible top - marking the return of the iconic MG roadster.",
    },
    {
      question: "What safety features does the MG Cyberster offer?",
      answer:
        "The Cyberster comes with active roll bars, Brembo high-performance braking calipers, Adaptive Cruise Control with Lane Center Centering, and anti-collision warning sensors.",
    },
    {
      question: "How do I book a test drive for the MG Cyberster?",
      answer:
        "You can book a test drive for the MG Cyberster online through our website or by calling MG Motor Mumbai. As an MG Select model, it's showcased at our dedicated MG Select showroom in Worli, where our team will arrange a bespoke test drive.",
    },
  ],
};
...
export const blogs: Blog[] = [
  ...
  },
  {
    ...
    readTime: "4 min read",
    image: "/images/blog-thumbs/blog-3-tips.jpg",
  ...
  },
  {
    ...
    readTime: "5 min read",
    image: "/images/blog-thumbs/blog-4-ismart.jpeg",
    coverImage: "/images/as-bn-dsc.jpg",
  ...
  },
  {
    ...
    coverImage: "/images/zs-bn-dsc.jpg",
    alt: "MG ZS EV SUV comparison",
    author: "Vikram Nair",
    authorRole: "Product Consultant",
    content: `<h2>The Question Every Buyer Asks</h2><p>Walk into any MG showroom in Mumbai today and chances are you're wrestling with the same dilemma: do I go petrol or electric? Both choices have compelling merits, and the right answer depends entirely on your lifestyle.</p><h2>The Daily Commuter (Under 60 km/day)</h2><p>If you're commuting within Mumbai, an EV is the clear winner. At ₹1.5–2 per km, charging your MG ZS EV or Windsor EV costs a fraction of petrol.</p><blockquote>For a 50 km daily commute, a petrol SUV costs approximately ₹350/day in fuel. The MG ZS EV costs just ₹75/day in electricity. That's ₹1 lakh saved annually.</blockquote><h2>The Weekend Road-Tripper</h2><p>If you frequently drive Mumbai–Pune or Mumbai–Goa, a petrol SUV like the MG Hector gives you the peace of mind of a familiar refuelling infrastructure.</p><h2>The Family of Five</h2><p>The MG Hector (5 or 7 seat), Astor, or Majestor are excellent choices for families who need interior space, a practical boot, and the flexibility of petrol at any filling station.</p><h2>Our Recommendation</h2><p>Book a consultation with our product advisors at MG Motor Mumbai. We'll analyse your driving patterns, parking situation, and budget to match you with the perfect MG.</p>`,
  },
  {
    ...
    readTime: "4 min read",
    image: "/images/models/model-majestor-corrected.png",
  ...
  },
  {
    ...
    readTime: "3 min read",
    image: "/images/models/model-comet-transparent.png",
    coverImage: "/images/hero-comet.jpg",
    alt: "MG Comet EV",
    author: "Divya Menon",
...
export type Location = {
  ...
  lat?: number;
  lng?: number;
  // Google Maps CID (place identifier) — https://www.google.com/maps?cid=<cid>
  // opens directly on this exact listing's info card, with no results list
  // or ambiguity, unlike a text search which can match similarly-named
  // dealers. Kept as a string since some CIDs exceed Number's safe range.
  cid?: string;
};
...
export const locations: Location[] = [
  {
    ...
    gmb: "https://share.google/tpg6bFcdA0OxuL48V",
    lat: 19.1759546,
    lng: 72.8369354,
  ...
  },
  {
    ...
    gmb: "https://share.google/pgv1qrHHqUn3Fq8V5",
    lat: 19.4054194,
    lng: 72.8541206,
  ...
  },
  {
    ...
    gmb: "https://share.google/TLY62MwRT1uYg6ypD",
    lat: 19.0125676,
    lng: 72.8250815,
  ...
  },
  {
    ...
    image: "/images/electric-car-news.jpg",
    lat: 18.9983176,
    lng: 72.8170158,
    cid: "12972394508041501080",
  },
];
