...
// hector intentionally omitted — its 360 frames have an unremovable
// third-party watermark on the numberplate, so the 360 viewer is disabled
// for this model and it falls back to the static preview card.
