            ...
            <div className="container-px mx-auto max-w-[1400px]">
              <Reveal variant="fade-up" className="mx-auto max-w-xl text-center">
                ...
                <p className="mt-3 text-sm text-slate-500 font-light sm:text-base">
                  Choose your model, a convenient time and a MG Motor showroom location. We&apos;ll confirm the car and help you compare the right variant, without any pressure to buy.
                </p>
              </Reveal>
            </div>
          </section>
